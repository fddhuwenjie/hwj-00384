const AVATAR_STYLES = ['adventurer', 'avataaars', 'bottts', 'fun-emoji', 'lorelei', 'micah', 'miniavs', 'personas', 'pixel-art', 'thumbs'];
const BACKGROUND_COLORS = ['b6e3f4', 'c0aede', 'd1d4f9', 'ffd5dc', 'ffdfbf', 'e0f3db', 'fde2e4', 'fad2e1', 'eddcd2', 'fff1e6'];
export const generateAvatar = (seed, style) => {
