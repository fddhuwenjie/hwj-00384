...
router.get('/', asyncHandler(async (req, res) => {
    ...
    const result = TeamService.getTeams({ page: pageNum, pageSize: size }, search);
    res.json(result);
}));
...
router.post('/:id/kick/:playerId', asyncHandler(async (req, res) => {
...
router.get('/matches', asyncHandler(async (req, res) => {
    ...
    const result = TeamService.getMatches({ page: pageNum, pageSize: size }, status);
    res.json(result);
}));
router.post('/matches/:id/start', asyncHandler(async (req, res) => {
    const { id } = req.params;
    const { operatorId } = req.body;
