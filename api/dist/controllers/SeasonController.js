...
router.get('/current/rankings', asyncHandler(async (req, res) => {
    const { page = 1, pageSize = 20 } = req.query;
...
router.get('/:id/rankings', asyncHandler(async (req, res) => {
    const { id } = req.params;
    const { page = 1, pageSize = 20 } = req.query;
    const season = SeasonService.getSeasonById(Number(id));
    if (!season) {
...
router.post('/check-reset', asyncHandler(async (req, res) => {
...
router.get('/player/:playerId/rank', asyncHandler(async (req, res) => {
