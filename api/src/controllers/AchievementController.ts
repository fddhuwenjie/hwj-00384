...
router.get('/player/:playerId/check', asyncHandler(async (req: Request, res: Response) => {
  const { playerId } = req.params;
...
router.get('/player/:playerId/progress', asyncHandler(async (req: Request, res: Response) => {
  const { playerId } = req.params;
